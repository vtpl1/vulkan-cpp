package com.videonetics.vulkan;
...
import static com.videonetics.vulkan.VKUtil.translateVulkanResult;

/**
 * Shows how to create a simple Vulkan instance and a canvas using
 * {@link AWTVK}.
 * 
 * @author Kai Burjack
 * @author SWinxy
...
public class SimpleDemo {
	...
	private static VkInstance createInstance() {
		try (MemoryStack stack = MemoryStack.stackPush()) {
			VkApplicationInfo appInfo = VkApplicationInfo.calloc(stack).sType(VK_STRUCTURE_TYPE_APPLICATION_INFO)
					.pApplicationName(stack.UTF8("AWT Vulkan Demo")).pEngineName(stack.UTF8(""))
					.apiVersion(VK_MAKE_VERSION(1, 0, 2));

			PointerBuffer ppEnabledExtensionNames = stack.pointers(stack.UTF8(VK_KHR_SURFACE_EXTENSION_NAME),
	...
	public static void main(String[] args) throws AWTException {
		...
		frame.pack(); // Packing causes the canvas to be lockable, and is the earliest time it can be
						// used
